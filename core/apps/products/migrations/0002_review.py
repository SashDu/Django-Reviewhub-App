...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('users', '0002_alter_customer_options_alter_customer_token'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_reviews', to='users.customer', verbose_name='Reviewer')),
            ],
            options={
